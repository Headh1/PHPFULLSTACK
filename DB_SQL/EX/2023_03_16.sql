...
-- SELECT RANK()over(ORDER BY sa.salary ASC) rank_sal , sa.emp_no, concat(emp.last_name,' ' ,emp.first_name) ,sa.salary , sa.to_date
-- FROM salaries sa 
-- 	INNER JOIN employees emp
-- 		on sa.emp_no=emp.emp_no limit 10;
...
-- WHERE title='Staff' and sa.to_date = '9999-01-01';
...
-- SELECT ti.title , ti.to_date, cast(AVG(sa.salary) AS int) AS avg_sal
-- FROM titles ti
-- 	inner JOIN salaries sa 
-- 		ON ti.emp_no = sa.emp_no
